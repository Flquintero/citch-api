// helpers
import { _getInstagramPost } from "../../services/facebook/pages/helpers/instagram-post-requests";
...
let $getInstagramPost = async function (
  ...
  try {
    ...
    if (req.body.postId) {
      const postData = await _getInstagramPost();
      // {
      //   postId,
      //   access_token: (facebookPageData as IFacebookPage)
      //     .access_token as string, // Page Token
