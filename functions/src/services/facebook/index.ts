...
//   _userAccessToken,
// } from './auth/helpers/facebook-user-auth-handler';
// import { _getFacebookPost } from './page/helpers/facebook-post-requests';
...
//   _getUserPages,
// } from './page/helpers/facebook-page-requests';
...
// import // FacebookConnectionStatus,
// // IFacebookPage,
// // FacebookPageLinkedStatus,
// // FacebookPageLinkedMessage,
// // IFacebookCampaignService,
// // IFacebookPagesService,
// // IFacebookAuthService,
// '../../types/modules/facebook';
// constants
...
//let campaigns: IFacebookCampaignService = require('./campaigns/index');
// let pages: IFacebookPagesService = require('./pages/index');
export default {
  auth,
  campaigns,
  pages,
